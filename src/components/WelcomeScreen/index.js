    ...
    <div>
      <Row className="welcome-row">
        <Col className="welcome-col">
          <img
            src={require("../../assets/images/keyboard-FF.png")}
            alt="Fast Finger"
        ...
        <Col className="welcome-form-col">
          <Form onSubmit={submitUserData}>
            <Form.Group controlId="formBasicEmail">
              ...
              {userName.trim() === "" ? (
                <p className="error-message">Please Fill Your Name</p>
              ) : (
                ""
              )}
            </Form.Group>
            <Form.Group controlId="exampleForm.ControlSelect1">
              ...
              {difficultyLevel.trim() === "" ? (
                <p className="error-message">Please Select Difficulty Level</p>
              ) : (
                ""
              )}
            </Form.Group>
            ...
            <button className="start-game-btn" type="submit">
              <img
                src={require("../../assets/images/play-btn-FF.png")}
                alt="Start Icon"
                className="play-icon"
              />
              START GAME
